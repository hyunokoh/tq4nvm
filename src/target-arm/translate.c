...
static inline void gen_aa32_ld##SUFF(TCGv_i32 val, TCGv_i32 addr, int index) \
{                                                                        \
    	gen_helper_dcache_access_read(addr);                             \
...
{                                                                       \
    ...
    tcg_gen_qemu_ld_i32(old_val, addr, index, OPC);                          \
    gen_helper_dcache_access_write(val, old_val, addr);                             \
...
static inline void gen_aa32_ld64(TCGv_i64 val, TCGv_i32 addr, int index)
{
	...
	//gen_helper_dcache_access_pure(val, addr);								
